...
namespace Compiler
{
    public partial class RegToNfa : Form
    {
        public RegToNfa()
        {
            InitializeComponent();
        ...
        {
            listResult.Columns[0].Width = listResult.Width / 3;
            listResult.Columns[1].Width = listResult.Width / 3;
            listResult.Columns[2].Width = listResult.Width / 3;
            lstDfa.Columns[0].Width = lstDfa.Width / 3;
            lstDfa.Columns[1].Width = lstDfa.Width / 3;
            lstDfa.Columns[2].Width = lstDfa.Width / 3;
        }
